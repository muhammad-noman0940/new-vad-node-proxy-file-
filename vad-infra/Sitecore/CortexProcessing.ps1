...
$cert=Get-AzKeyVaultCertificate -VaultName 'Secrets212' -Name 'CortexProcessing'
...
$certpath="C:\Packages\Certificates\CortexProcessing.pfx"
# Write to a file
...
Install-SitecoreConfiguration –Path "C:\Packages\Devops\Configs\xconnect-xp1-CortexProcessing.json"

...
$cert=Get-AzKeyVaultCertificate -VaultName 'vadtestvault' -Name 'CortexReporting'
...
$certpath="C:\Packages\Certificates\CortexReporting.pfx"
# Write to a file
...
Install-SitecoreConfiguration –Path "C:\Packages\Devops\Configs\xconnect-xp1-CortexReporting.json"

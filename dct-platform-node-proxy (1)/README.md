...
- Change set NODE_ENV=development in .env file
- Self generate Certificate and replace if current certificate(server.cert, server.key) does not works for you.
...
- Change set NODE_ENV=production in .env file

...
$cert=Get-AzKeyVaultCertificate -VaultName 'Secrets212' -Name 'SitecoreReporting'
...
$certpath="C:\Packages\Certificates\SitecoreReporting.pfx"
# Write to a file
...
Install-SitecoreConfiguration -Path "C:\Packages\Devops\Configs\sitecore-XP1-rep.json"

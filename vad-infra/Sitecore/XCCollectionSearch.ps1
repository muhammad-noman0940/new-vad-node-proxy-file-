...
$cert=Get-AzKeyVaultCertificate -VaultName 'vadtestvault' -Name 'XConnectionCollectionSearch'
...
$certpath="C:\Packages\Certificates\XConnectCollectionSearch.pfx"
# Write to a file
...
Install-SitecoreConfiguration -Path "C:\Packages\Devops\Configs\xconnect-xp1-collectionsearch.json"
Stop-Service XConnectCollectionSearch-indexworker
sc.exe delete XConnectCollectionSearch-indexworker

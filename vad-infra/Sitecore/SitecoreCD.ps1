...
$cert=Get-AzKeyVaultCertificate -VaultName 'Secrets212' -Name 'SitecoreCD'
...
$certpath="C:\Packages\Certificates\SitecoreCD.pfx"
# Write to a file
...
Install-SitecoreConfiguration -Path "C:\Packages\Devops\Configs\xconnect-xp1-cd.json"

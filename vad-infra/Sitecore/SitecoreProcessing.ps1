...
$cert=Get-AzKeyVaultCertificate -VaultName 'Secrets212' -Name 'SitecoreProcessing'
...
$certpath="C:\Packages\Certificates\SitecoreProcessing.pfx"
# Write to a file
...
Install-SitecoreConfiguration -Path "C:\Packages\Devops\Configs\sitecore-XP1-prc.json"
